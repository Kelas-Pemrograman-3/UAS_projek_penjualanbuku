   ...
   <q-dialog v-model="openedit" v-if="openedit">
      <q-card style="width: 700px; max-width:80vw;">
        ...
        <q-separator/>
          ...
          <q-input label ="Quantity" v-model ="activedata.Quantity"></q-input>
...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        { name: 'Id_Buku', align: 'center', label: 'Id Buku', field: 'Id_Buku', sortable: true },
        { name: 'Quantity', label: 'Quantity', field: 'Quantity', sortable: true },
        { name: 'Nama', label: 'Nama Penerima', field: 'Quantity', sortable: true },
        { name: 'Alamat', label: 'Alamat Penerima', field: 'Alamat', sortable: true }
      ],
      data: [],
      original: [],
      openedit: false,
  ...
  methods: {
    ...
    edit () {
      this.$axios.put('order/edit/' + this.activedata._id, this.activedata)
        .then(res => {
          if (res.data.error) {
